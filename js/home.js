...
(function($){
	...
	getVideos(function(data) {
	    ...
	    for (var i=0; i < data.length; i++) {
	    	if(i < 1) {
		    	videoContent = "<a href='"+data[i].mobile_url+"' target='_blank' title='watch "+data[i].title+"'>"+
					              	"<img src='"+data[i].thumbnail_large+"'/>"+
					                "<h3>"+data[i].title+"</h3>"+
					                "<p><i>"+data[i].upload_date+"</i></p>"+
					              "</a>";

		    	$("#last-video").append(videoContent);
		    } else {
		    	return;
		    }
	    };
	}, function(jqXHR) { // error callback
	    $("#last-video").append("<a href='https://vimeo.com/channels/611476' title='watch 242 videos on Vimeo'>Watch 242 Videos on Vimeo</a>");
	...
	var feed = new Instafeed({
        get: 'tagged',
        tagName: '242cfc',
        clientId: 'acb7ae81a3ae4cd0ba1176b9d6550b20'
    });
    feed.run();
